...
class ZillowManager:
    ...
    def house_search(self):
        self.price_button = self.driver.find_element(By.ID, "price")
        self.price_button.click()
        time.sleep(1)
        self.price_button_min = self.driver.find_element(By.XPATH, '//*[@id="min-500000"]/button')
        self.price_button_min.click()
        self.price_button_max = self.driver.find_element(By.XPATH, '//*[@id="max-700000"]/button')
        self.price_button_max.click()
        time.sleep(1)
        self.more_button = self.driver.find_element(By.ID, "beds")
        self.more_button.click()
        self.bedrooms_button = self.driver.find_element(By.XPATH, '//*[@id="beds-form"]/fieldset[1]/div[1]/button[2]')
        self.bedrooms_button.click()
        self.bathrooms_button = self.driver.find_element(By.XPATH, '//*[@id="beds-form"]/fieldset[2]/div/button[2]')
        self.bathrooms_button.click()
        self.done_button = self.driver.find_element(By.XPATH,
                                                    '//*[@id="search-page-react-content"]/section/div[2]/div/div[3]/div/div/div/button')
